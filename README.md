...
1. Buka `index.html`.
2. Klik **Admin**.
3. Pada produk yang ingin diubah, klik **Edit**.
4. Ubah **Nama Produk, Harga, Stok, Kategori, Foto, atau Deskripsi**.
5. Untuk foto, pilih **Choose File / Pilih File** lalu pilih foto dari HP/komputer.
6. Klik **Save product**.

Perubahan langsung tampil di halaman toko. Data tersimpan di browser yang digunakan.
